...
import AccumulativeBtn from './AccumulativeBtn'; // Import the AccumulativeBtn component

const AccumulativeSidebar = ({ isOpen, toggleSidebar, rollId }) => {
  ...
  return (
    <>
      ...
      <div className={`sidebar drawer-sidebar d-flex flex-column ${isOpen ? 'open' : ''}`}>
        ...
        {rollId === 'monazam' && <AccumulativeBtn />}
...
export default AccumulativeSidebar;
